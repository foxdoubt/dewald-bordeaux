...
export const ALBUM_SECTION_SANITY_ID = "c9c76326-1b83-4352-9502-224c9ff397fd";
export const Album = ({ description }) => {
  const richTextComponents = {
    block: {
      normal: ({ children }) => (
        <p className="page-section-content">{children}</p>
      ),
    },
  };
...
export const ABOUT_SECTION_SANITY_ID = "236624a9-67fd-468b-a85a-4b6cdbc45136";

export const About = ({ description }) => {
  const richTextComponents = {
    block: {
      normal: ({ children }) => {
        return <p className="about-text page-section-content">{children}</p>;
      },
    },
  };
  return (
