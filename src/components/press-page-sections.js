  ...
  return (
    <div className="flex-container flex-main-center">
      <button onClick={onSubmit} disabled={isDisabled} className="pointer">
        <a href={href} target="_blank" rel="noopener" data-initialized="true">
        ...
        <div className="album-description">
          ...
          <div className="album-description-text page-section-content">
            <p className="page-section-content">
              ...
              broken. DeWald/Bordeaux’s debut self-titled album takes up the
              messy contradictions of emotional life with a palette of acoustic
              instruments, driving and dreamy rock and lush cinematic
              ...
              same breath — that there’s beauty and grace within the tumult of
              the sensitive soul.
            </p>
          </div>
        </div>
  ...
  <div>
    ...
    <div>
      <p className="about-text page-section-content">
        ...
        Bordeaux went on to tour the US and Europe with rock bands The Isles,
        Rahim (Frenchkiss Records) and Golden Suits (Yep Roc Records) and has
        scored multiple feature films, including Obvious Child and Landline.
      ...
      <p className="about-text page-section-content">
        ...
        unsentimental, scrutinizing listener and rewards multiple listens. In
        Dewald/Bordeaux, lovers of late 1960s/early 1970s singer-songwriters may
        hear vintage elements ranging from Graham Parsons, Emmit Rhodes, The
        Zombies, Paul McCartney and Gordon Lightfoot, along with more recent
        throwbacks like Elliott Smith and Mazzy Star.{" "}
      </p>
      <p className="about-text page-section-content">
...
export const LatestSharedPosts = () => {
  ...
  return (
    <div className="text-align-center">
      ...
      <div
        className="flex-container flex-main-center"
        dangerouslySetInnerHTML={{ __html: igEmbed }}
      />
    </div>
  );
};
